...
class POPUPSHeader extends Component {
    state = {
        searchType:'',
    ...
    render() {
        const { searchPOPUPS, mainTheme} = this.props;
    ...
    return bindActionCreators(
        {
            ...
            searchPOPUPS: Actions.searchPOPUPS
        },
        dispatch
    );
}

function mapStateToProps({popUpsApp, fuse}) {
    return {
