...
class WarrantyCompletionApp extends Component {
  componentDidMount() {
    this.props.getWarrantyCompletion(this.props.match.params);
  }
...
export default withReducer('warrantyCompletionApp', reducer)(
  withStyles(styles, { withTheme: true })(
    withRouter(
      connect(
        mapStateToProps,
        mapDispatchToProps
      )(WarrantyCompletionApp)
    )
  )
);
