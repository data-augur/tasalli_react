...
class WarrantyCompletionsHeader extends Component {
    state = {
        companyId:''
    };
    render() {
        const {searchWarrantyCompletionByCompany, mainTheme} = this.props;
                ...
                <div className="d-flex flex-column flex-1 items-center justify-center pr-8 sm:px-12">
                    ...
                    <div className="flex flex-1 items-center justify-center pr-8 sm:px-12">
                        <Button
                            ...
                            color="secondary"
                            onClick={() => {
                                searchWarrantyCompletionByCompany(this.state.companyId);
                            }}
                        >
                            Apply
                        </Button>
    ...
    return bindActionCreators(
        {
            ...
            searchWarrantyCompletionByCompany: Actions.searchWarrantyCompletionByCompany
        },
        dispatch
    );
}

function mapStateToProps({warrantyCompletionApp, fuse}) {
    return {
