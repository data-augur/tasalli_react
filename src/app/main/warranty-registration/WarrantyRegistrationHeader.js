...
class WarrantyRegistrationsHeader extends Component {
    state = {
        companyId:''
    };
    render() {
        const { searchWarrantyRegistrationByCompany, mainTheme} = this.props;
                ...
                <div className="d-flex flex-column flex-1 items-center justify-center pr-8 sm:px-12">
                    ...
                    <div className="flex flex-1 items-center justify-center pr-8 sm:px-12">
                        <Button
                            ...
                            color="secondary"
                            onClick={() => {
                                searchWarrantyRegistrationByCompany(this.state.companyId);
                            }}
                        >
                            Apply
                        </Button>
    ...
    return bindActionCreators(
        {
            ...
            searchWarrantyRegistrationByCompany: Actions.searchWarrantyRegistrationByCompany
        },
        dispatch
    );
}

function mapStateToProps({warrantyRegistrationApp, fuse}) {
    return {
