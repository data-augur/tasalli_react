...
class WarrantyClaimAttributesHeader extends Component {
  render() {
          ...
          <div className="flex items-center">
            <FuseAnimate animation="transition.slideLeftIn" delay={300}>
              <Typography variant="h5" className="hidden sm:flex">
                {
                  localStorage.getItem('WarrantyClaimFormName')
                }
              </Typography>
            </FuseAnimate>
          </div>
...
function mapStateToProps({ warrantyClaimAttributeApp, fuse }) {
  return {
